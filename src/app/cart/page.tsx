...
// Role: Shopping cart page with quantity controls, remove buttons, toast notifications, and animations
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-96">
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-sm shadow-md p-6 sticky top-24"
            >
